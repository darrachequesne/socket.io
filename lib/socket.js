...
Socket.prototype.buildHandshake = function(){
  return {
    ...
    xdomain: !!this.client.request.headers.origin,
    secure: !!this.client.request.connection.encrypted,
    issued: +(new Date),
    url: this.client.request.url,
    query: url.parse(this.client.request.url, true).query || {}
  };
};
